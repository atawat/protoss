...
{
	public class ProductPropertyValueSearchCondition
	{
		/// <summary>
		/// 页码
		/// </summary>
		...
		public EnumProductPropertyValueSearchOrderBy? OrderBy { get; set; }

	}


	public enum EnumProductPropertyValueSearchOrderBy
	{
