 ...
 */
app.controller('orderCertain', ['$http', '$scope', '$stateParams', '$ionicLoading', '$timeout', '$state', '$ionicPopup', 'AuthService', '$ionicHistory', 'wc', function ($http, $scope, $stateParams, $ionicLoading, $timeout, $state, $ionicPopup, AuthService, $ionicHistory, wc) {
    //清除页面堆栈
